...
def get_resource_path(resource_package, resource_path):
    resource = files(resource_package) / resource_path
...
_libdir = get_resource_path(resource_package, resource_path)
